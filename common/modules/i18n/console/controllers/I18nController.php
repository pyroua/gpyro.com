...
namespace common\modules\I18n\console\controllers;
...
class I18nController extends Controller
{
    ...
    /**
     *  Метод дозволяє імпортувати переклади в базу
     *
     ...
     */
    public function actionImportM($sourcePath = null, $language = 'ru-RU', $category = '*')
    {
