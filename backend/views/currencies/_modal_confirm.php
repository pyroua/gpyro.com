    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?=Yii::t('back', 'Delete currency'); ?></h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <a href="<?= Url::to(['currencies/delete/' . $id]) ?>" type="button" class="btn btn-danger"><?=Yii::t('back', 'Yes'); ?></a>
            </div>
        </div>
    </div>
</div>